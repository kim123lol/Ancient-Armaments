...
import net.kim123lol.ancientarmaments.network.ExampleServerboundPacket;
...
public class ExampleItem extends Item {
	...
	public static final String EXAMPLE_TOOLTIP = AncientArmaments.lang("tooltip.example_item.example_tooltip");
